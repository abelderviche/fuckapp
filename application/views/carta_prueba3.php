...
<div id="container" class="ed-container" style="background:#e0e0e0;font-size:14px;margin-top:38px;">
  <div class="ed-item" >
    ...
    <div class="namEmpresa">Sres. <?=ucfirst($datos["empresa"]);?> S.A.</div>
      <div class="carta">
        Concurro a efectos de manifiestar mi disconformidad 
        respecto de los términos en los que el servicio se encuentra siendo prestado. 
        <br><br>
        Toda vez que, la situación descripta no resulta imputable a acción u omisión 
        alguna por esta parte, solicito, tenga a bien arbitrar 
        los medios necesarios para regularizar las condiciones 
        de la prestación del servicio en cuestion. <br>
        <br>
        Sin otro particular. 
      </div>
